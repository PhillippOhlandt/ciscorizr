...
<html>
    <head>
        ...
        <style type="text/css" media="screen">
            {{ (new ColoredCss(array("47b3e2", "5977c1", "e34a58", "f98646", "f8be46", "baca5c")))->withFontColor()->withHover(array("a1d7f0", "8397cf", "f2a3a9", "fcc1a2", "faca6a", "dae4ac"))->render();  }}
        </style>
    ...
    <body>
        <div class="container">
        <div class="row head">
            <div class="col-md-6 col-sm-6 col-xs-6 logo color_font color_font-1"><a href="/" target="_blank" class="color_font color_font-1">Ciscorizr</a></div>

...
@section('content')
	...
	<div class="row">
		<div class="col-md-12"><h2><span class="color color_font color_font-1">Edit Answer:</span> {{ $answer->title }}</h2></div>
	</div>

	@include('admin.components.errormessages', ['errors' => $errors])

	{{ Form::open(array('route' => array('answer-edit', $course->id, $chapter->id, $question->id, $answer->id))) }}
		<div class="row">
		    <div class="col-md-12 col-sm-12">
			    <div class="form-group">
					{{ Form::label('title', 'Title') }}
	    			{{ Form::text('title', $answer->title ,array('class' => 'form-control')) }}
		    	</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
		    	<div class="form-group">
			    	<div class="checkbox">
					    <label>{{ Form::checkbox('is_correct', 'is_correct', $answer->is_correct) }}Correct</label>
					</div>
			    </div>
		    </div>
	    </div>

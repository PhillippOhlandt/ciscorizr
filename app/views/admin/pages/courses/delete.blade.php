...
@section('content')
	...
	<div class="row">
		<div class="col-md-12"><h2><span class="color color_font color_font-1">Delete Course:</span> {{ $course->title }}</h2></div>
	</div>

	@include('admin.components.errormessages', ['errors' => $errors])

	<div class="row">
		{{ Form::open(array('route' => array('course-delete', $course->id))) }}

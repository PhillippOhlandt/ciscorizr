...
@section('content')
	...
	<div class="row">
		<div class="col-md-12"><h2><span class="color color_font color_font-1">Delete Chapter:</span> {{ $chapter->title }}</h2></div>
	</div>

	@include('admin.components.errormessages', ['errors' => $errors])

	<div class="row">
		{{ Form::open(array('route' => array('chapter-delete', $course->id, $chapter->id))) }}

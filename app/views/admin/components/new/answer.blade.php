...
<div class="row">
		...
		{{ Form::open(array('route' => array('answer-new', $course->id, $chapter->id, $question->id))) }}
		    <div class="col-md-4 col-sm-12">
			    <div class="form-group">
				    {{ Form::text('title', null, array('class' => 'form-control', 'placeholder'=>'Answer')) }}
			    </div>
		    </div>
		    ...
		    <div class="col-md-4 col-sm-12">
			    <div class="form-group">
			    	<div class="checkbox">
			    		<label>
				    		{{ Form::checkbox('is_correct', 'is_correct') }} Is Correct
				    	</label>
				    </div>
			    </div>
		    </div>
